              ...
              <ol role="list" className="flex items-center space-x-2">
                <li>
                  <div className="flex items-center text-sm">
                    <a href="/projects" className="font-medium text-gray-500 hover:text-gray-900">Projects</a>
              ...
              <div className="flex items-center">
                ...
                {project.published_at && (
                  <div className="ml-4 border-l border-gray-300 pl-4">
                    ...
                    <div className="flex items-center">
                      <p className="ml-2 text-sm text-gray-500">Released at {new Date(project.published_at).toLocaleDateString('en-US', {
                        day: 'numeric',
                        month: 'long',
                        year: 'numeric',
                        timeZone: 'UTC',
