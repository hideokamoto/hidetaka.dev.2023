...
describe('extractCategories', () => {
  it('should extract dev-note-category taxonomy from _embedded.wp:term', () => {
    const note: WPThought = {
      ...
      modified: '2025-12-15T23:56:00',
      modified_gmt: '2025-12-15T23:56:00',
      ...
      json: async () => [
        {
          ...
          modified: '2025-12-14T23:00:00',
          modified_gmt: '2025-12-14T23:00:00',
      ...
      json: async () => [
        {
          ...
          modified: '2025-01-01T23:00:00',
          modified_gmt: '2025-01-01T23:00:00',
